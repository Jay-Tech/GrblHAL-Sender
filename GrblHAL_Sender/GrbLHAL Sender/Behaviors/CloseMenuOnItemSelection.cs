...
namespace GrbLHAL_Sender.Behaviors
{
    ...
    public class CloseMenuOnItemSelection: AvaloniaObject
    {
        ...
        public static readonly AttachedProperty<ICommand> CommandProperty = AvaloniaProperty.RegisterAttached<CloseMenuOnItemSelection, Interactive, ICommand>(
        ...
        public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<CloseMenuOnItemSelection, Interactive, object>(
