...
/// </summary>
public class DTHorBehavor : AvaloniaObject
{
    static DTHorBehavor()
    {
    ...
    public static readonly AttachedProperty<ICommand> CommandProperty = AvaloniaProperty.RegisterAttached<DTHorBehavor, Interactive, ICommand>(
    ...
    public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<DTHorBehavor, Interactive, object>(
