...
/// </summary>
public class FocusToCommand : AvaloniaObject
{
    static FocusToCommand()
    {
    ...
    public static readonly AttachedProperty<ICommand> CommandProperty = AvaloniaProperty.RegisterAttached<FocusToCommand, Interactive, ICommand>(
    ...
    public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<FocusToCommand, Interactive, object>(
    ...
    private static void HandleCommandChanged(AvaloniaObject element, ICommand commandValue)
    {
        if (element is Interactive interactElem)
        {
            ...
            {
                // Add non-null value
                interactElem.AddHandler(InputElement.GotFocusEvent, Handler);
            }
            else
            {
                // remove prev value
                interactElem.RemoveHandler(InputElement.GotFocusEvent, Handler);
            }
        }
